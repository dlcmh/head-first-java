public class GuessGame {
        ...
        // method to be called by main() method in GameLauncher class
        public void startGame() {
                ...
                while(true) {
                        ...
                        // if a player is right, then set that player's variable (initially set as false) to be true
                        ...
                        // stop when any player guesses right
                        if (p1isRight || p2isRight || p3isRight) {
                                ...
                                // stay in the loop and ask the players for another guess
